 ...
 * @desc			script de prétraitement pour la fabrication de la grille résultat d'une recherche de mail
 * 					Ce script est une boite noire réutilisable pour affiche une grille de mails
 * 
 ...
 * 
 * @creationdate	mercredi 30 juillet 2009
 * @updates
 */
?>
<?php
