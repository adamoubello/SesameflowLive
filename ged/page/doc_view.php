...
<form action="<?php echo $siteweb->get_url()."/ged/traitements/partie_centrale.php"; ?>" method="post" name="form_doc_view"  id="form_doc_view" enctype="multipart/form-data">
	...
	<input type="hidden" name="elements" id="elements" value="Va voir" />
	
	
	<?php 
	if (trim(strtolower($typedoc)) == "numeric")
	{
			...
			<td width="50%" valign="top">
				...
				<table class="admintable" width="100%">
					...
					<tr>
						...
						<td>
							<input type="text" name="auteur" id="auteur" class="inputbox" size="30" value="<?php echo $document->nomuser." ".$document->prenomuser; ?>" disabled/>
						</td>
					</tr>				
					<tr>
						<td class="key">
