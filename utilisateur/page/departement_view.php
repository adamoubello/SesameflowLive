...
<table width="100%">
	<tr>
		<td>	
			<form action="<?php echo $siteweb->get_url()."/utilisateur/traitements/partie_centrale.php"; ?>" method="post" name="form_departement_view" id="form_departement_view" >
				<input type="hidden" id="lang" name="lang" value="<?php echo $lang ?>">
				<input type="hidden" id="login" name="login" value="<?php echo $login ?>">
				<input type="hidden" id="do" name="do" value="dep_update_valid">
				<input type="hidden" id="codedep" name="codedep" value="<?php echo $dep->codedep ;?>">
			
				<div>
					<fieldset class="adminform">
					<legend> <?php echo ucfirst($translate["moddonneesdep"]); ?> </legend>
						<table class="admintable" cellspacing="1">
							...
							<tr>
								...
								<td>
			<input disabled type="text" name="txt_codedep" id="txt_codedep" class="inputbox" size="10" value="<?php echo $dep->codedep; ?>" />					                    </td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="libdep" id="libdep" class="inputbox" size="50" value="<?php echo $dep->libdep; ?>" />
