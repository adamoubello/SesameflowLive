 ...
 */
 ...
 if (is_null($translate)) $translate = array();
	...
	$translate["processus_search"]	=  htmlspecialchars("Recherche de procédure d'entreprise");
	$translate["processus_view"]	=  htmlspecialchars("Consultation de procédure d'entreprise");
	$translate["processus_create"]	=  htmlspecialchars("Création de procédure d'entreprise");
    $translate["processus_create_valid"] = htmlspecialchars("Validation création d'une procédure d'entreprise");
    $translate["processus_update_valid"] = htmlspecialchars("Validation modification d'une procédure d'entreprise");
    $translate["processus_delete_valid"] = htmlspecialchars("Validation suppression d'une procédure d'entreprise");
    ...
    $translate["workflow_search"]= htmlspecialchars("Recherche de traitement");
    $translate["workflow_view"]= htmlspecialchars("Consultation de traitement");
    ...
    $translate["processus"]= htmlspecialchars("procédure d'entreprise");
