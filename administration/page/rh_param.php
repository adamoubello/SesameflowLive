			...
			<tr>
				<td valign="top">
					<fieldset class="adminform">
						<legend><?php echo ucfirst($translate["interfacage_rh"]); ?></legend>
							<table class="admintable" cellspacing="1">
								...
								<tr>
									<td  class="key" width="50%">
										<span class="editlinktip hasTip" title="Type de base de données de la rh">
							...
							<tr>
								<td width="60%" class="key">
									<span class="editlinktip hasTip" title="Nom du serveur::Nom d'hôte de votre base de données de la rh saisit lors de l'installation. Ne modifiez pas ce champ sauf absolue nécessité, comme par exemple lors d'un transfert vers un nouvel hôte.">
						...
						<tr>				
							<td class="key">
								<span class="editlinktip hasTip" title="Identifiant::Identifiant pour l'accès à la base de données de la rh saisit lors de l'installation.  Ne modifiez pas ce champ sauf absolue nécessité, comme par exemple lors d'un transfert vers un nouvel hôte.">
						...
						<tr>
							<td class="key">
								<span class="editlinktip hasTip" title="Base de données::Nom de votre base de données de la rh saisit lors de l'installation. Ne modifiez pas ce champ sauf absolue nécessité, comme par exemple lors d'un transfert vers un nouvel hôte.">
