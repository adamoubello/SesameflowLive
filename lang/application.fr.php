 ...
 */
 ...
 if (is_null($translate)) $translate = array();
	...
	$translate["any_processus_found"]	=  htmlspecialchars("Aucune procédure d'entreprise n'existe ");
	...
	$translate["creer_processus"] = htmlspecialchars("Création d'une procédure d'entreprise");
	...
	$translate["info_bulle_processus"]	=  htmlspecialchars("Afficher ou rechercher les informations sur les procédures d'entreprise");		
	...
	$translate["mes_taches"]	=  htmlspecialchars("Mes Tâches en cours");
	...
	$translate["modification_workflow"]	=  htmlspecialchars("modification d'un traitement");
	...
	$translate["recherche_processus"]	=  htmlspecialchars("recherche de procédure d'entreprise");
